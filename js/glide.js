!function () {
  ...
  function p(t, e) {
    var n = s({}, t, e);
    return e.hasOwnProperty("classes") && (n.classes = s({}, t.classes, e.classes),
      e.classes.hasOwnProperty("direction") && (n.classes.direction = s({}, t.classes.direction, e.classes.direction))),
      e.hasOwnProperty("breakpoints") && (n.breakpoints = s({}, t.breakpoints, e.breakpoints)),
      n
  }
  var m = function () {
    function t() {
      ...
      return o(t, [{
        ...
        value: function () {
          ...
          return this._e.emit("mount.before"),
            l(t) ? this._c = function (t, e, i) {
              var r = {};
              for (var o in e)
                f(e[o]) ? r[o] = e[o](t, r, i) : n("Extension must be a function");
              for (var s in r)
                f(r[s].mount) && r[s].mount();
              return r
            }(this, t, this._e) : n("You need to provide a object on `mount()`"),
        ...
        value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
          return h(t) ? this._t = t : n("You need to provide a array on `mutate()`"),
            this
        }
      }, {
        key: "update",
        value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return this.settings = p(this.settings, t),
        ...
        set: function (t) {
          l(t) ? this._o = t : n("Options must be an `object` instance.")
        }
      }, {
        key: "index",
        get: function () {
    ...
    return {
      mutate: function (o) {
        for (var s = 0; s < r.length; s++) {
          var u = r[s];
          f(u) && f(u().modify) ? o = u(t, e, i).modify(o) : n("Transformer should be a function that returns an object with `modify()` method")
        }
        return o
      }
    }
  ...
  var P = M
    ...
    , z = ["touchend", "touchcancel", "mouseup", "mouseleave"]
    ...
    return l(t) ? (e = t,
      Object.keys(e).sort().reduce(function (t, n) {
        return t[n] = e[n],
          t[n],
          t
      }, {})) : (n("Breakpoints option must be an object"),
        {});
    var e
  }
  var G = {
    Html: function (t, e) {
      ...
      return v(i, "root", {
        ...
        set: function (t) {
          c(t) && (t = document.querySelector(t)),
            k(t) ? i._r = t : n("Root element must be a existing Html node")
        }
      }),
        v(i, "track", {
          get: function () {
          ...
          set: function (t) {
            k(t) ? i._t = t : n("Could not find track element. Please use " + S + " attribute.")
          }
        }),
        v(i, "wrapper", {
          get: function () {
    ...
    Direction: function (t, e, i) {
      ...
      return v(r, "value", {
        ...
        set: function (t) {
          T.indexOf(t) > -1 ? r._v = t : n("Direction value must be `ltr` or `rtl`")
        }
      }),
    ...
    Peek: function (t, e, n) {
      ...
      return v(i, "value", {
        ...
        set: function (t) {
          l(t) ? (t.before = a(t.before),
            t.after = a(t.after)) : t = a(t),
            i._v = t
        }
      }),
        v(i, "reductor", {
    ...
    Gaps: function (t, e, n) {
      var i = {
        apply: function (t) {
          for (var n = 0, i = t.length; n < i; n++) {
            var r = t[n].style
              , o = e.Direction.value;
            r[w[o][0]] = 0 !== n ? this.value / 2 + "px" : "",
              n !== t.length - 1 ? r[w[o][1]] = this.value / 2 + "px" : r[w[o][1]] = ""
          }
        },
        remove: function (t) {
      ...
      return v(i, "value", {
        ...
        n.on(["build.after", "update"], b(function () {
          ...
          switch (o) {
            case ">":
              ">" === r ? t.index = i : this.isEnd() ? t.isType("slider") && !t.settings.rewind || (this._o = !0,
                t.index = 0) : s ? t.index += Math.min(i - t.index, -a(r)) : t.index++;
              break;
            case "<":
              "<" === r ? t.index = 0 : this.isStart() ? t.isType("slider") && !t.settings.rewind || (this._o = !0,
                t.index = i) : s ? t.index -= Math.min(t.index, a(r)) : t.index--;
              break;
            case "=":
              t.index = r;
              break;
            default:
              n("Invalid direction pattern [" + o + r + "] has been used")
          }
        },
        isStart: function () {
          return 0 === t.index
      ...
      return v(r, "move", {
        ...
        v(r, "length", {
          get: function () {
            ...
            return t.isType("slider") && "center" !== n.focusAt && n.bound ? i - 1 - (a(n.perView) - 1) + a(n.focusAt) : i - 1
          }
        }),
        v(r, "offset", {
          get: function () {
      ...
      var i = new H
        ...
        , l = {
          ...
          move: function (i) {
            if (!t.disabled) {
              var u = t.settings
                ...
                , g = Math.sqrt(p + m)
                , y = Math.sqrt(m);
              if (!(180 * (r = Math.asin(y / g)) / Math.PI < c))
                return !1;
              i.stopPropagation(),
            ...
            if (!t.disabled) {
              ...
              this.enable(),
                l > c && f < s.touchAngle ? (s.perTouch && (d = Math.min(d, a(s.perTouch))),
                  e.Direction.is("rtl") && (d = -d),
                  e.Run.make(e.Direction.resolve("<" + d))) : l < -c && f < s.touchAngle ? (s.perTouch && (d = Math.max(d, -a(s.perTouch))),
                    e.Direction.is("rtl") && (d = -d),
          ...
          bindSwipeStart: function () {
            var n = this
              , r = t.settings;
            r.swipeThreshold && i.on(L[0], e.Html.wrapper, function (t) {
              n.start(t)
            }, c),
              r.dragThreshold && i.on(L[1], e.Html.wrapper, function (t) {
                n.start(t)
              }, c)
          },
          unbindSwipeStart: function () {
            i.off(L[0], e.Html.wrapper, c),
              i.off(L[1], e.Html.wrapper, c)
          },
          bindSwipeMove: function () {
            var n = this;
            i.on(j, e.Html.wrapper, b(function (t) {
              n.move(t)
            }, t.settings.throttle), c)
          },
          unbindSwipeMove: function () {
            i.off(j, e.Html.wrapper, c)
          },
          bindSwipeEnd: function () {
            var t = this;
            i.on(z, e.Html.wrapper, function (e) {
              t.end(e)
            })
          },
          unbindSwipeEnd: function () {
            i.off(z, e.Html.wrapper)
          },
          touches: function (t) {
            return D.indexOf(t.type) > -1 ? t : t.touches[0] || t.changedTouches[0]
          },
          threshold: function (e) {
            var n = t.settings;
            return D.indexOf(e.type) > -1 ? n.dragThreshold : n.swipeThreshold
          },
          enable: function () {
            return u = !1,
              e.Transition.enable(),
    ...
    Controls: function (t, e, n) {
      var i = new H
        ...
        , o = {
          mount: function () {
            this._n = e.Html.root.querySelectorAll(E),
    ...
    Breakpoints: function (t, e, n) {
      ...
      return s(r, a.match(o)),
        i.on("resize", window, b(function () {
          t.settings = p(r, a.match(o))
        }, t.settings.throttle)),
        n.on("update", function () {
          o = W(o),
            u = s({}, r)
    ...
    , B = function (e) {
      ...
      return function (e, n) {
        if ("function" != typeof n && null !== n)
          throw new TypeError("Super expression must either be null or a function, not " + (void 0 === n ? "undefined" : t(n)));
        ...
        o(n, [{
          ...
          value: function () {
            ...
            }(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "mount", this).call(this, s({}, G, t))
          }
        }]),
        n
    }();
